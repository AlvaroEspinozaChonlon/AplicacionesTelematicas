...
public class list extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException{
        ...
        try{
            con = DriverManager.getConnection (url, "root", "marta");
	        ...
	        if (type.equals("all_activities")){
				...
				rs=stmt.executeQuery("SELECT * FROM PAVILLIONS"); 
	        }
			...
			else if (type.equals("activities_name_desc")){
				rs=stmt.executeQuery("SELECT * FROM ACTIVITIES WHERE (NAME LIKE '%"+text+"%' OR DESCRIPTION LIKE '%"+text+"%') ORDER BY "+order); 
	        }
